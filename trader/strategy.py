...
# 从其他模块导入必要的类
from event import Event, MarketEvent, SignalEvent, FillEvent, OrderEvent, TimerEvent
from event_engine import EventEngine
from data_handler import IDataHandler
from portfolio import Position # Import the Position dataclass
...
class IStrategy(ABC):
    ...
    def handle_event(self, event: Event):
        ...
        if event.event_type == MarketEvent.event_type:
            ...
            if market_event.symbol in self.symbols: self.on_market_data(market_event)
